...
@Configuration
class ConfigurationServiceClientHandler(
    private val configurationServiceClientConfig: ConfigurationServiceClientConfig
) {
    ...
    fun getWebClient(): WebClient {
        val webClient = WebClient.builder()
            .baseUrl(configurationServiceClientConfig.endpoint)
            .build()
        return webClient
            .mutate()
            .clientConnector(
